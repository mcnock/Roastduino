...
void ProcessAdjust_01Vmenu(int i) {
    ...
    if (moveamount != 0.0 ){
      if (VerticalMenuPrior == VmenuDebug && VerticalButtonPrior == VBUT7 ){
          Duty = Duty + moveamount;
       
      }
      if (VerticalMenuPrior == Vmenubase && VerticalButtonPrior == VBUT2 ){
