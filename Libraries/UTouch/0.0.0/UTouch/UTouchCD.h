...
// These calibration settings works with my ER-TFTM050-4
// They MIGHT work on your display module, but you should run the
// calibration sketch anyway


#define CAL_X 0x0024CF54UL   //ER-TFTM050-4
#define CAL_Y 0x0075CF30UL   //ER-TFTM050-4
#define CAL_S 0x8031F1DFUL   //ER-TFTM050-4
